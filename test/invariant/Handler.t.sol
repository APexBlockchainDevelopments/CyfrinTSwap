...
contract Handler is Test {
    ...
    function swapPoolTokenForWethBasedOnOutputWeth(uint256 outputWethAmount) public {
        ...
        // If these are the same, we will divide by 0
        ...
        //We * -1 since we remivng WETH from the system
    ...
    function deposit(uint256 wethAmountToDeposit) public {
        //make the amount a reasonable number, we don't expect someone to ahve type(uint256).max weth
